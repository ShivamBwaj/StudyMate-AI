      ...
      <div className="max-w-3xl mx-auto px-4 py-6 h-full flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="mt-4 flex flex-col sm:flex-row gap-2 items-center">
          <div className="flex gap-2">
            ...
            <input type="file" accept=".pdf" id="pdf-upload" onChange={(e) => uploadFile(e, "http://localhost:8000/chat-pdf", "📎 Uploaded:")} className="hidden" />
            ...
            <input type="file" accept=".png,.jpg,.jpeg" id="image-upload" onChange={(e) => uploadFile(e, "http://localhost:8000/chat-ocr", "🖼️ Uploaded:")} className="hidden" />
          </div>
